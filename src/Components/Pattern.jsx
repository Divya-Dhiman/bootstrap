        ...
        <div className='row'>
          <div className='col-lg-8 offset-lg-2 col-md-12 col-12'>
            <div className='text-center'>
              <small className='text-uppercase ls-md fw-semibold'>About Block</small>
              <h1 className='mb-3 mt-3'>Empowering the world to design</h1>
              <p className='mb-0 px-lg-6'>
                We are Block, a Digital Product Design & Branding Agency. As a team of Designers, Business Analysts, Strategists, Content Writers, and Project Managers, we collaborate on a result-oriented design process.
              </p>
            </div>
          </div>
        </div>
               ...
               <div class="row gy-5">
                  <div class="col-lg-3 col-md-6 col-12">
                     <figure class="mb-4 zoom-img">
                        <img src={team1} alt="team1" class="rounded-3 img-fluid"></img>
                     </figure>
                     <div class="mb-4">
                        <h4 class="mb-1"><a href="#!" class="text-reset">Jitu Chauhna</a></h4>
                  ...
                  <div class="col-lg-3 col-md-6 col-12">
                     <figure class="mb-4 zoom-img">
                        <img src={team2} alt="team2" class="rounded-3 img-fluid"></img>
                     </figure>
                     <div class="mb-4">
                        <h4 class="mb-1"><a href="#!" class="text-reset">Anita Parmar</a></h4>
                  ...
                  <div class="col-lg-3 col-md-6 col-12">
                     <figure class="mb-4 zoom-img">
                        <img src={team3} alt="team3" class="rounded-3 img-fluid"></img>
                     </figure>
                     <div class="mb-4">
                        <h4 class="mb-1"><a href="#!" class="text-reset">Sandip Chauhan</a></h4>
                  ...
                  <div class="col-lg-3 col-md-6 col-12">
                     <figure class="mb-4 zoom-img">
                        <img src={team4} alt="team4" class="rounded-3 img-fluid"></img>
                     </figure>
                     <div class="mb-4">
                        <h4 class="mb-1"><a href="#!" class="text-reset">Manasvi Suthar</a></h4>
                        <span class="fs-6">Lead Developer</span>
                     </div>
